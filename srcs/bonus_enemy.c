...
/*   Updated: 2024/04/18 17:51:50 by tlay             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	enemy_run_game(t_vars *vars, int new_pos_x, int new_pos_y, int i)
{
	...
	else if (vars->map.array[new_pos_x][new_pos_y] == '0')
	{
		...
		if (i == 0)
			vars->map.array[new_pos_x][new_pos_y] = 'w';
		else if (i == 1)
			vars->map.array[new_pos_x][new_pos_y] = 'a';
		else if (i == 3)
			vars->map.array[new_pos_x][new_pos_y] = 'd';
		else
			vars->map.array[new_pos_x][new_pos_y] = 'e';
	}
...
int	enemy_mov(int keycode, t_vars *vars)
{
	...
	{
		if (i == 0)
			enemy_run_game(vars, x - 1, y, i);
		else if (i == 1)
			enemy_run_game(vars, x, y - 1, i);
		else if (i == 2)
			enemy_run_game(vars, x + 1, y, i);
		else if (i == 3)
			enemy_run_game(vars, x, y + 1, i);
