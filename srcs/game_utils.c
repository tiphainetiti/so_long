...
/*   Updated: 2024/04/18 18:38:41 by tlay             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	destroy_img_enemy(t_vars *vars)
{
	...
	if (vars->img.enemy_back_grass)
		mlx_destroy_image(vars->mlx.mlx, vars->img.enemy_back_grass);
	if (vars->img.enemy_right_grass)
		mlx_destroy_image(vars->mlx.mlx, vars->img.enemy_right_grass);
	if (vars->img.enemy_left_grass)
		mlx_destroy_image(vars->mlx.mlx, vars->img.enemy_left_grass);
}
